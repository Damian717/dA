...
battery_life = Label(root, font = 'arial15 bold', bg ='black', fg='white')
batter_life.place(relx=0.5,rely=0.5, anchor=CENTER)

def convertTime(seconds):
    get_taim = time.gmtime(seconds)
...
def getBatterylife():
    ...
    if battery.secsleft == BatteryTime.POWER_TIME_UNLIMITED:
        ...
        battery_life['text'] ='Battery life did not detected. \n Place, Run the code again!'
    else:
        battery_life['text'] ="Battery Life : "+batter_left
